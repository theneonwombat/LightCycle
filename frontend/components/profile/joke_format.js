function formatJokes(jokes) {
  let jokeArray = jokes.split('\n');
  let noBlanks = jokeArray.filter(joke => joke.length > 0)
  console.log(noBlanks);
}

const allJokes = `On the other hand, you have different fingers.
